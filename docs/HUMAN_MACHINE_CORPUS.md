...
## قاعدة إلزامية للتنقل في النصوص المجزأة

أي ملف `segment` موجه للقراءة البشرية يجب أن ينتهي بشريط تنقل واضح يحتوي، بحسب موقعه في السلسلة، على:

- الجزء السابق؛
- فهرس اللغة (`../ar.md` أو `../fr.md`)؛
- الجزء التالي؛
- العودة إلى `README.md` الخاص بالنص.
...
الجزء الأول لا يحتاج رابط «السابق»، والجزء الأخير لا يحتاج رابط «التالي». هذه الروابط **واجهة تنقل فقط** وليست جزءًا من المتن القانوني أو transcription الرسمية.

يجب كذلك أن يحتوي ملف فهرس اللغة `ar.md` أو `fr.md` على قائمة مرتبة بجميع الأجزاء.
...
- أين يمكن فتح **PDF الرسمي الأصلي** مباشرة؟

الشرح والفهرسة في README من عمل المشروع، ولا يخلطان بالنص الرسمي.

### روابط المصدر الرسمي في الواجهة البشرية

يجب أن يحتوي كل `README.md` بشري على قسم ظاهر بعنوان قريب من:

```markdown
## المصدر الرسمي الأصلي — PDF
```

ويعرض، عندما تكون الروابط محسومة:

- رابط PDF العربي الرسمي في JORADP؛
- رابط PDF الفرنسي الرسمي في JORADP؛
- رقم الجريدة وتاريخها والصفحات المناسبة لكل لغة؛
- رابط `sources/sources.yml` للتفاصيل المهيكلة.

مثال:

```markdown
- [الجريدة الرسمية — النسخة العربية (PDF رسمي، العدد ...، الصفحات ...)](https://www.joradp.dz/...)
- [Journal officiel — version française (PDF officiel, n° ..., pages ...)](https://www.joradp.dz/...)
- [بيانات المصدر والمحددات](sources/sources.yml)
```

إذا لم يحسم رابط إحدى اللغات بعد، **لا يخترع رابط**. يذكر بوضوح أن الرابط المباشر ما زال قيد الحل، ويعرض الرابط المتحقق فقط.

وجود رابط PDF في `README.md` لا يعني تخزينه في Git؛ هو رابط خارجي إلى المصدر الرسمي لتسهيل المراجعة البشرية.
...
- `DZ-DE-2018-162`: العربية والفرنسية كلتاهما `verified` ومجزأتان إلى segments مترابطة بروابط تنقل.
...
`README.md` يعرض روابط المصدر للإنسان، بينما `sources.yml` يبقى التمثيل المهيكل المرجعي لهذه الروابط للآلة.
...
- `DZ-DE-2018-162`: أول نص طويل ثنائي اللغة مجزأ، مع روابط تنقل داخل الأجزاء وروابط PDF رسمية ظاهرة في الواجهة البشرية.
